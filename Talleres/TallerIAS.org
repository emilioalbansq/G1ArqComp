...
1. ¿Qué resultado se tiene al final en el registro del acumulador?
   ...
   - En formato Decimal es -3
   - En formato Hexadecimal es FFFFFFFFFD
...
2. ¿Se sobrescribe algún registro como resultado de la ejecución? Si
   ...
   Respuesta:
   - $[940] \leftarrow FFFFFFFFFD$
   - $[941] \leftarrow 0000000006$
   - $[AC] \leftarrow FFFFFFFFFD$
...
3. ¿Cuál es el valor del bit de Carry? ¿Qué operación modifica el bit?
   ...
   - Aunque después de la instrucción $SUB M(941)$, es decir la
...
| Samuel Churaco | samuel.churaco@epn.edu.ec | Integrante |
|----------------+---------------------------+------------|
...
- Tarea $X_1$ no pudo completarse debido a: N/A
- Tarea $X_2$ no pudo completarse debido a: N/A
