...
siguientes preguntas considerando la Tabla \ref{tab:org23b7fc5} como el
mapa de memoria de la máquina y obtenga el programa en lenguaje ensamblador y en
RTL.

\begin{table}[htbp]
\caption{\label{tab:org23b7fc5}Mapa de Memoria}
\centering
\begin{tabular}{rrrrr}
\hline
